...
public class GerenciadorSessaoTest {
	...
	public void DeveRetornarFalsoQuandoNaoCabe() {
		...
		Filme f1 = new Filme("Os trapalhoes", Duration.ofMinutes(120),"Aventura");
		Sala sala = new Sala("3D");
		Sessao s1 = new Sessao(duasEMeia, f1, sala);
		List<Sessao> sessoesExistentes = Arrays.asList(
					new Sessao (LocalTime.of(10,00),new Filme("Titanic",Duration.ofMinutes(90),"Drama"), sala),
					new Sessao (LocalTime.of(13,00),new Filme("DuckTales",Duration.ofMinutes(120),"Aventura"), sala),
					new Sessao (LocalTime.of(20,00),new Filme("Hora do Pesadelo",Duration.ofMinutes(120),"Terror"), sala)
					);
